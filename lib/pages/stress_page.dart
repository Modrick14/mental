...
class StressPage extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              _buildSectionHeader("Your Stress Insights"),

              // Side-by-side: Stress Level & AI Interaction
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        _imageBox("assets/stress_meter.jpg"),
                      ],
                    ),
                  ),
                  const SizedBox(width: 10),

                  // Right: Let's Interact
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _buildSectionHeader("Let's Interact"),
                        _imageBox("assets/ai_interact.jpeg"),
                      ],
                    ),
                  ),
                ],
              ...
              // Resources on Stress (horizontal)
              _buildSectionHeader("Resources on Stress"),
              SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: Row(
                  children: [
                    _resourceIcon(context, "Books", "assets/stress_book.jpeg",
                        "https://drchatterjee.com/books/the-stress-solution/"),
                    _resourceIcon(context, "Videos", "assets/stress_video.jpeg",
                        "https://www.youtube.com/watch?v=sTpo1FuYQ9I"),
                    _resourceIcon(context, "Connect", "assets/therapy.jpeg",
                        "https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwi6nLqhnMOMAxWCimgJHWtUBl8YABAAGgJ3Zg&co=1&gclid=CjwKCAjwzMi_BhACEiwAX4YZUO6slaBjiSK3efXWj1gPn6SkaxZxbqcjayhwmFoTTXneICa5vItn7BoCtEIQAvD_BwE&ohost=www.google.com&cid=CAESVuD2-bVUgJTDFavWqh0ycQMw1dlXd5Zzf2Wx3c8Sa9bhAG8h0z1JZPBKZOL07aaGk9NAEbz-kyMA7tl7yHx5LoeXD2l6c346F0WizXYJTuBN6lvxPFlI&sig=AOD64_3wc5oVLIk2yrY0fEMzu37GKH_bdA&q&adurl&ved=2ahUKEwiAyLGhnMOMAxXZRvEDHVPtIZYQ0Qx6BAgWEAE"),
                  ],
                ),
              ),
  ...
  // Horizontal Resource Icon (Clickable)
